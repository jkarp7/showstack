  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Share projects and collaborate with team members</p>
      </div>
        ...
        <div className="space-y-3">
          {['john@example.com', 'sarah@example.com'].map((email, i) => (
            <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <button className="text-sm text-gray-400 cursor-not-allowed">Remove</button>
            </div>
          ))}

          <button className="w-full p-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-400 cursor-not-allowed">
            + Invite Team Member
          </button>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 opacity-60">
        ...
        <div className="space-y-3">
          <div className="p-3 bg-gray-50 rounded-lg">
            <div className="font-medium text-gray-900 mb-1">Default Sharing Permission</div>
            <select disabled className="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed">
