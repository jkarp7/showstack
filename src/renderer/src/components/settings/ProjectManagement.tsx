    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-2">Recent Projects List</h4>
          <div className="space-y-2">
            {['The Phantom of the Opera', 'Hamilton', 'Wicked'].map((project, i) => (
              <div key={i} className="flex items-center justify-between p-2 bg-white dark:bg-gray-800 rounded border border-gray-200">
                ...
                <button className="text-xs text-blue-600 dark:text-blue-500 hover:text-blue-700">Pin</button>
              </div>
            ))}
          </div>
        </div>
