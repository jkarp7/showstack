...
export function WorkspacePreferences() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Workspace Preferences</h2>
        <p className="text-gray-600">Customize your workspace layout and default views</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Which view opens when you start the application</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div>
              <div className="font-medium text-gray-900">Show Grid</div>
              <div className="text-sm text-gray-500">Display grid lines in designer</div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div>
              <div className="font-medium text-gray-900">Snap to Grid</div>
              <div className="text-sm text-gray-500">Automatically align elements to grid</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="font-medium text-gray-900 mb-1">Imperial</div>
            <div className="text-sm text-gray-500">Feet, inches (ft, in)</div>
          </button>
          ...
          >
            ...
            <div className="text-sm text-gray-500">Meters, centimeters (m, cm)</div>
          </button>
        </div>
      </div>
