    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div className="flex items-start justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <div className="flex-1">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Enable Developer Tools</h4>
      ...
      <div className="bg-amber-50 dark:bg-gray-800 border border-amber-200 dark:border-amber-500 rounded-lg p-4">
        <div className="flex items-start gap-2">
          ...
          <div>
            <h4 className="font-medium text-amber-900 dark:text-gray-200 mb-1">Performance Impact</h4>
