...
export function EditorSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Editor Settings</h2>
        <p className="text-gray-600">Configure layout editor behavior and tools</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">More steps use more memory</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
          <div>
            <div className="font-medium text-gray-900">Show Toolbar</div>
            <div className="text-sm text-gray-500">Display toolbar in editor</div>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={action} className="flex justify-between items-center p-2 hover:bg-gray-50 rounded">
              <span className="text-sm text-gray-700">{action}</span>
              <kbd className="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-mono">{shortcut}</kbd>
            </div>
          ))}
        </div>
      </div>
