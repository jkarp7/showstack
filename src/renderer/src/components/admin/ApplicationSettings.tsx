      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Default location for exported layouts and files</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Default location for saving new projects</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-600 mt-1">
              Example: <span className="font-mono bg-gray-100 px-1 rounded">cover_layout_2024-12-01.json</span>
            </p>
          </div>
        </div>
      </div>
