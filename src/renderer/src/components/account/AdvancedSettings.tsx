  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div className="flex items-start justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <div className="flex-1">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Anonymous Usage Statistics</h4>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div className="flex items-start justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <div className="flex-1">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Early Access to New Features</h4>
