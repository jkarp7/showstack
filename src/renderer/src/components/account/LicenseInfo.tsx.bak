          ...
          <>
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">{licenseType} License</h3>
                  <p className="text-sm text-gray-500">Active license</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="font-semibold text-gray-900">{licenseType}</div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
