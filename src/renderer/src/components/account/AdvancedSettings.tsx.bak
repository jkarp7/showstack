  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Telemetry and beta feature access</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
          <div className="flex-1">
            <h4 className="font-medium text-gray-900 mb-2">Anonymous Usage Statistics</h4>
            <p className="text-sm text-gray-600 mb-3">
              Help improve ShowStack by sending anonymous usage data. This includes which features you use,
              performance metrics, and crash reports. No personal data or project content is collected.
            </p>
          ...
          <label className="ml-4 relative inline-flex items-center cursor-pointer">
            <input type="checkbox" checked={telemetryEnabled} onChange={(e) => setTelemetryEnabled(e.target.checked)} className="sr-only peer" />
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
          <div className="flex-1">
            <h4 className="font-medium text-gray-900 mb-2">Early Access to New Features</h4>
            <p className="text-sm text-gray-600 mb-2">
              Get early access to new features before they're officially released. Beta features may be unstable
              or incomplete.
            </p>
          ...
          <label className="ml-4 relative inline-flex items-center cursor-pointer">
            <input type="checkbox" checked={betaFeatures} onChange={(e) => setBetaFeatures(e.target.checked)} className="sr-only peer" />
