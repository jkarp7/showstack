...
export const COLUMN_CONFIGS: ColumnConfig[] = [
  ...
  { key: 'user1', label: 'User 1', width: 'w-24', group: 'User Columns' },
  { key: 'user2', label: 'User 2', width: 'w-24', group: 'User Columns' },
  { key: 'user3', label: 'User 3', width: 'w-24', group: 'User Columns' },
  { key: 'user4', label: 'User 4', width: 'w-24', group: 'User Columns' },
  { key: 'user5', label: 'User 5', width: 'w-24', group: 'User Columns' },
  { key: 'user6', label: 'User 6', width: 'w-24', group: 'User Columns' },
  { key: 'user7', label: 'User 7', width: 'w-24', group: 'User Columns' },
  { key: 'user8', label: 'User 8', width: 'w-24', group: 'User Columns' },
  { key: 'user9', label: 'User 9', width: 'w-24', group: 'User Columns' },
  { key: 'user10', label: 'User 10', width: 'w-24', group: 'User Columns' },
  { key: 'user11', label: 'User 11', width: 'w-24', group: 'User Columns' },
  { key: 'user12', label: 'User 12', width: 'w-24', group: 'User Columns' },
  { key: 'user13', label: 'User 13', width: 'w-24', group: 'User Columns' },
  { key: 'user14', label: 'User 14', width: 'w-24', group: 'User Columns' },
  { key: 'user15', label: 'User 15', width: 'w-24', group: 'User Columns' },
  { key: 'user16', label: 'User 16', width: 'w-24', group: 'User Columns' },
  { key: 'user17', label: 'User 17', width: 'w-24', group: 'User Columns' },
  { key: 'user18', label: 'User 18', width: 'w-24', group: 'User Columns' },
  { key: 'user19', label: 'User 19', width: 'w-24', group: 'User Columns' },
  { key: 'user20', label: 'User 20', width: 'w-24', group: 'User Columns' },
  { key: 'user21', label: 'User 21', width: 'w-24', group: 'User Columns' },
  { key: 'user22', label: 'User 22', width: 'w-24', group: 'User Columns' },
  { key: 'user23', label: 'User 23', width: 'w-24', group: 'User Columns' },
  { key: 'user24', label: 'User 24', width: 'w-24', group: 'User Columns' },
];
