...
export function DataPrivacy() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Data & Privacy</h2>
        ...
        <div className="space-y-3">
          <div className="flex items-start justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Download all your profile data, settings, and preferences
              </p>
            </div>
            <button
              onClick={handleExportData}
              className="ml-4 flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-gray-900 dark:text-white rounded-md transition-colors"
            >
          ...
          <div className="flex items-start justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Permanently remove all your data from the application
              </p>
            </div>
            <button
              onClick={handleDeleteData}
              className="ml-4 flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-gray-900 dark:text-white rounded-md transition-colors"
            >
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <div className="text-lg font-semibold text-gray-900 dark:text-white">90 days</div>
          </div>
          <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Audit Logs</div>
            <div className="text-lg font-semibold text-gray-900 dark:text-white">90 days</div>
          </div>
          <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Backups</div>
