          ...
          {[
            {
              ...
              desc: 'Notify when file exports finish',
              state: exportComplete,
              setState: setExportComplete,
            },
            {
              label: 'Validation Warnings',
              desc: 'Alert on potential issues in layouts',
              state: validationWarnings,
              setState: setValidationWarnings,
            },
            {
              label: 'Change Detection',
              desc: 'Notify when equipment changes between revisions',
              state: changeDetection,
              setState: setChangeDetection,
            },
            {
              label: 'App Updates',
              desc: 'Notify about new versions and features',
              state: updates,
              setState: setUpdates,
            },
