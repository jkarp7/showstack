    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Configure layout editor behavior and tools
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div>
          ...
          <input
            ...
            max="200"
            step="10"
            value={editor.undoDepth}
            onChange={(e) => updateEditor({ undoDepth: parseInt(e.target.value) })}
            className="w-full"
          />
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            More steps use more memory
          </p>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              ...
              onChange={(e) => updateEditor({ showToolbar: e.target.checked })}
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-2">
          {[
            ...
            <div
              key={action}
              className="flex justify-between items-center p-2 hover:bg-gray-50 dark:bg-gray-700/50 rounded"
            >
              <span className="text-sm text-gray-700 dark:text-gray-300">{action}</span>
              <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 border border-gray-300 rounded text-xs font-mono">
                {shortcut}
              </kbd>
            </div>
          ))}
